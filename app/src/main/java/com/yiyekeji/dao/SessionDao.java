...
public class SessionDao extends AbstractDao<Session, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UnRead = new Property(3, Integer.class, "unRead", false, "UN_READ");
    ...
    public Session readEntity(Cursor cursor, int offset) {
        Session entity = new Session( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3), // unRead
    ...
    public void readEntity(Cursor cursor, Session entity, int offset) {
        ...
        entity.setUnRead(cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3));
